 ...
 */
class QuoteGuestCartRepositoryV1Controller extends BaseController
{
    /**
     * @var QuoteGuestCartRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return QuoteGuestCartRepositoryV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getQuoteGuestCartRepositoryV1GetGet(
        $cartId
    ) {
