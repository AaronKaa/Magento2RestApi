 ...
 */
class CatalogProductCustomOptionTypeListV1Controller extends BaseController
{
    /**
     * @var CatalogProductCustomOptionTypeListV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return CatalogProductCustomOptionTypeListV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getCatalogProductCustomOptionTypeListV1GetItemsGet()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/products/options/types';
        ...
        return $mapper->mapClassArray($response->body, 'MagentoCommunityLib\\Models\\CatalogDataProductCustomOptionTypeInterface');
    }
}
