 ...
 */
class CatalogProductTierPriceManagementV1Controller extends BaseController
{
    /**
     * @var CatalogProductTierPriceManagementV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return CatalogProductTierPriceManagementV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getCatalogProductTierPriceManagementV1GetListGet(
        $sku,
        $customerGroupId
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/products/{sku}/group-prices/{customerGroupId}/tiers';
        ...
        return $mapper->mapClassArray($response->body, 'MagentoCommunityLib\\Models\\CatalogDataProductTierPriceInterface');
    }
     ...
     * @param string $sku             TODO: type description here
     * @param string $customerGroupId 'all' can be used to specify 'ALL GROUPS'
     * @param double $price           TODO: type description here
     * @param double $qty             TODO: type description here
     * @return bool response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createCatalogProductTierPriceManagementV1AddPost(
        $sku,
        $customerGroupId,
        $price,
        $qty
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteCatalogProductTierPriceManagementV1RemoveDelete(
        $sku,
        $customerGroupId,
        $qty
    ) {
