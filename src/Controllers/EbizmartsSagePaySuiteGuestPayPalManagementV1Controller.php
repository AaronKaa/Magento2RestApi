 ...
 */
class EbizmartsSagePaySuiteGuestPayPalManagementV1Controller extends BaseController
{
    /**
     * @var EbizmartsSagePaySuiteGuestPayPalManagementV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return EbizmartsSagePaySuiteGuestPayPalManagementV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getEbizmartsSagePaySuiteGuestPayPalManagementV1SavePaymentInformationAndPlaceOrderGet(
        $cartId
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/sagepay/paypal-guest/{cartId}';
