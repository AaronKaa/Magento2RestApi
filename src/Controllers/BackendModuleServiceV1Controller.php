 ...
 */
class BackendModuleServiceV1Controller extends BaseController
{
    /**
     * @var BackendModuleServiceV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return BackendModuleServiceV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getBackendModuleServiceV1GetModulesGet()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/modules';
