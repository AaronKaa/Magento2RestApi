 ...
 */
class QuoteGuestCartTotalRepositoryV1Controller extends BaseController
{
    /**
     * @var QuoteGuestCartTotalRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return QuoteGuestCartTotalRepositoryV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getQuoteGuestCartTotalRepositoryV1GetGet(
        $cartId
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/guest-carts/{cartId}/totals';
