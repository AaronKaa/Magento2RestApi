 ...
 */
class AnalyticsLinkProviderV1Controller extends BaseController
{
    /**
     * @var AnalyticsLinkProviderV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return AnalyticsLinkProviderV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getAnalyticsLinkProviderV1GetGet()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/analytics/link';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\AnalyticsDataLinkInterface');
    }
}
