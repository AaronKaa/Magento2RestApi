 ...
 */
class SalesCreditmemoCommentRepositoryV1Controller extends BaseController
{
    /**
     * @var SalesCreditmemoCommentRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SalesCreditmemoCommentRepositoryV1Controller The *Singleton* instance.
     */
     ...
     *                                                                                                              her
     *                                                                                                              e
     * @param Models\SalesCreditmemoCommentRepositoryV1SavePostBody $salesCreditmemoCommentRepositoryV1SavePostBody (op
     *                                                                                                              tio
     *                                                                                                              nal
     *                                                                                                              )
     *                                                                                                              TOD
     ...
     */
    public function createSalesCreditmemoCommentRepositoryV1SavePost(
        $id,
        ...
        $response = Request::post(
            $_queryUrl,
            $_headers,
            Request\Body::Json($salesCreditmemoCommentRepositoryV1SavePostBody)
        );
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\SalesDataCreditmemoCommentInterface');
    }
}
