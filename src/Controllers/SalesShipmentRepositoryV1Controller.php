 ...
 */
class SalesShipmentRepositoryV1Controller extends BaseController
{
    /**
     * @var SalesShipmentRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SalesShipmentRepositoryV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getSalesShipmentRepositoryV1GetGet(
        $id
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/shipment/{id}';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\SalesDataShipmentInterface');
    }

    /**
     * Lists shipments that match specified search criteria. This call returns an array of objects, but
     * detailed information about each object’s attributes might not be included. See http://devdocs.
     * magento.com/codelinks/attributes.html#ShipmentRepositoryInterface to determine which call to use to
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getSalesShipmentRepositoryV1GetListGet(
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/shipments';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\SalesDataShipmentSearchResultInterface');
    }

    /**
     * Performs persist operations for a specified shipment.
     *
     * @param Models\SalesShipmentRepositoryV1SavePostBody $salesShipmentRepositoryV1SavePostBody (optional) TODO: type
     *                                                                                            description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createSalesShipmentRepositoryV1SavePost(
        $salesShipmentRepositoryV1SavePostBody = null
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/shipment/';
        ...
        //and invoke the API call request to fetch the response
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($salesShipmentRepositoryV1SavePostBody));
