 ...
 */
class BundleProductOptionTypeListV1Controller extends BaseController
{
    /**
     * @var BundleProductOptionTypeListV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return BundleProductOptionTypeListV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getBundleProductOptionTypeListV1GetItemsGet()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/bundle-products/options/types';
        ...
        return $mapper->mapClassArray($response->body, 'MagentoCommunityLib\\Models\\BundleDataOptionTypeInterface');
    }
}
