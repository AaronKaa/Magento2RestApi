 ...
 */
class EavAttributeSetRepositoryV1Controller extends BaseController
{
    /**
     * @var EavAttributeSetRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return EavAttributeSetRepositoryV1Controller The *Singleton* instance.
     */
    ...
    /**
     * Retrieve list of Attribute Sets This call returns an array of objects, but detailed information
     * about each object’s attributes might not be included. See http://devdocs.magento.
     * com/codelinks/attributes.html#AttributeSetRepositoryInterface to determine which call to use to get
     ...
     */
    public function getEavAttributeSetRepositoryV1GetListGet(
        ...
        $_queryBuilder = $_queryBuilder.'/V1/eav/attribute-sets/list';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\EavDataAttributeSetSearchResultsInterface');
    }

    /**
     * Retrieve attribute set information based on given ID
     *
     * @param integer $attributeSetId TODO: type description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function getEavAttributeSetRepositoryV1GetGet(
        $attributeSetId
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/eav/attribute-sets/{attributeSetId}';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\EavDataAttributeSetInterface');
    }
     ...
     *                                                                                              description here
     * @param Models\EavAttributeSetRepositoryV1SavePutBody $eavAttributeSetRepositoryV1SavePutBody (optional) TODO:
     *                                                                                              type description
     *                                                                                              here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateEavAttributeSetRepositoryV1SavePut(
        $attributeSetId,
        ...
        //and invoke the API call request to fetch the response
        $response = Request::put($_queryUrl, $_headers, Request\Body::Json($eavAttributeSetRepositoryV1SavePutBody));
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteEavAttributeSetRepositoryV1DeleteByIdDelete(
        $attributeSetId
    ) {
