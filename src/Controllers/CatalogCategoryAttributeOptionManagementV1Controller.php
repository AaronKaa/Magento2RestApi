 ...
 */
class CatalogCategoryAttributeOptionManagementV1Controller extends BaseController
{
    /**
     * @var CatalogCategoryAttributeOptionManagementV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return CatalogCategoryAttributeOptionManagementV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getCatalogCategoryAttributeOptionManagementV1GetItemsGet(
        $attributeCode
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/categories/attributes/{attributeCode}/options';
