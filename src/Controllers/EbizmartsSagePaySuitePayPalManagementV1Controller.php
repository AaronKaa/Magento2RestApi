 ...
 */
class EbizmartsSagePaySuitePayPalManagementV1Controller extends BaseController
{
    /**
     * @var EbizmartsSagePaySuitePayPalManagementV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return EbizmartsSagePaySuitePayPalManagementV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getEbizmartsSagePaySuitePayPalManagementV1SavePaymentInformationAndPlaceOrderGet(
        $cartId
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/sagepay/paypal/{cartId}';
