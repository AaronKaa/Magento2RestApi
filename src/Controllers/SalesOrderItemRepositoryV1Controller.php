 ...
 */
class SalesOrderItemRepositoryV1Controller extends BaseController
{
    /**
     * @var SalesOrderItemRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SalesOrderItemRepositoryV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getSalesOrderItemRepositoryV1GetGet(
        $id
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/orders/items/{id}';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\SalesDataOrderItemInterface');
    }

    /**
     * Lists order items that match specified search criteria. This call returns an array of objects, but
     * detailed information about each object’s attributes might not be included. See http://devdocs.
     * magento.com/codelinks/attributes.html#OrderItemRepositoryInterface to determine which call to use to
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getSalesOrderItemRepositoryV1GetListGet(
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/orders/items';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\SalesDataOrderItemSearchResultInterface');
    }
}
