 ...
 */
class SalesRefundOrderV1Controller extends BaseController
{
    /**
     * @var SalesRefundOrderV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SalesRefundOrderV1Controller The *Singleton* instance.
     */
     ...
     *
     * @param integer                                  $orderId                           TODO: type description here
     * @param Models\SalesRefundOrderV1ExecutePostBody $salesRefundOrderV1ExecutePostBody (optional) TODO: type
     *                                                                                    description here
     * @return integer response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createSalesRefundOrderV1ExecutePost(
        $orderId,
        ...
        $_queryBuilder = $_queryBuilder.'/V1/order/{orderId}/refund';
        ...
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($salesRefundOrderV1ExecutePostBody));
