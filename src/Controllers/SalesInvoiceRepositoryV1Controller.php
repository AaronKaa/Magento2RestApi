 ...
 */
class SalesInvoiceRepositoryV1Controller extends BaseController
{
    /**
     * @var SalesInvoiceRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SalesInvoiceRepositoryV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getSalesInvoiceRepositoryV1GetGet(
        $id
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/invoices/{id}';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\SalesDataInvoiceInterface');
    }

    /**
     * Lists invoices that match specified search criteria. This call returns an array of objects, but
     * detailed information about each object’s attributes might not be included. See http://devdocs.
     * magento.com/codelinks/attributes.html#InvoiceRepositoryInterface to determine which call to use to
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getSalesInvoiceRepositoryV1GetListGet(
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/invoices';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\SalesDataInvoiceSearchResultInterface');
    }

    /**
     * Performs persist operations for a specified invoice.
     *
     * @param Models\SalesInvoiceRepositoryV1SavePostBody $salesInvoiceRepositoryV1SavePostBody (optional) TODO: type
     *                                                                                          description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createSalesInvoiceRepositoryV1SavePost(
        $salesInvoiceRepositoryV1SavePostBody = null
    ) {
        ...
        //and invoke the API call request to fetch the response
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($salesInvoiceRepositoryV1SavePostBody));
