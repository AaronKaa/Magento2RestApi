 ...
 */
class SalesShipmentCommentRepositoryV1Controller extends BaseController
{
    /**
     * @var SalesShipmentCommentRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SalesShipmentCommentRepositoryV1Controller The *Singleton* instance.
     */
     ...
     *                                                                                                          tion
     *                                                                                                          here
     * @param Models\SalesShipmentCommentRepositoryV1SavePostBody $salesShipmentCommentRepositoryV1SavePostBody (option
     *                                                                                                          al)
     *                                                                                                          TODO:
     *                                                                                                          type
     *                                                                                                          descrip
     ...
     */
    public function createSalesShipmentCommentRepositoryV1SavePost(
        $id,
        ...
        $response = Request::post(
            $_queryUrl,
            $_headers,
            Request\Body::Json($salesShipmentCommentRepositoryV1SavePostBody)
        );
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\SalesDataShipmentCommentInterface');
    }
}
