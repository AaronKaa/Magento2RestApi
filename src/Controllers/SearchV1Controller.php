 ...
 */
class SearchV1Controller extends BaseController
{
    /**
     * @var SearchV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SearchV1Controller The *Singleton* instance.
     */
     ...
     *
     * @param string  $searchCriteriaRequestName                                (optional) TODO: type description here
     ...
     */
    public function searchV1SearchGet(
        ...
        $_queryBuilder = $_queryBuilder.'/V1/search';

        //process optional query parameters
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array (
            'searchCriteria[requestName]'                              => $searchCriteriaRequestName,
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\FrameworkSearchSearchResultInterface');
    }
}
