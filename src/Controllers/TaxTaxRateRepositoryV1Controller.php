 ...
 */
class TaxTaxRateRepositoryV1Controller extends BaseController
{
    /**
     * @var TaxTaxRateRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return TaxTaxRateRepositoryV1Controller The *Singleton* instance.
     */
     ...
     *
     * @param Models\TaxTaxRateRepositoryV1SavePutBody $taxTaxRateRepositoryV1SavePutBody (optional) TODO: type
     *                                                                                    description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateTaxTaxRateRepositoryV1SavePut(
        $taxTaxRateRepositoryV1SavePutBody = null
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/taxRates';
        ...
        $response = Request::put($_queryUrl, $_headers, Request\Body::Json($taxTaxRateRepositoryV1SavePutBody));
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\TaxDataTaxRateInterface');
    }

    /**
     * Create or update tax rate
     *
     * @param Models\TaxTaxRateRepositoryV1SavePutBody $taxTaxRateRepositoryV1SavePostBody (optional) TODO: type
     *                                                                                     description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createTaxTaxRateRepositoryV1SavePost(
        $taxTaxRateRepositoryV1SavePostBody = null
    ) {
        ...
        //and invoke the API call request to fetch the response
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($taxTaxRateRepositoryV1SavePostBody));
     ...
     * Get tax rate
     *
     * @param integer $rateId TODO: type description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function getTaxTaxRateRepositoryV1GetGet(
        $rateId
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/taxRates/{rateId}';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteTaxTaxRateRepositoryV1DeleteByIdDelete(
        $rateId
    ) {
    ...
    /**
     * Search TaxRates This call returns an array of objects, but detailed information about each object’s
     * attributes might not be included. See http://devdocs.magento.com/codelinks/attributes.
     * html#TaxRateRepositoryInterface to determine which call to use to get detailed information about all
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getTaxTaxRateRepositoryV1GetListGet(
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/taxRates/search';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\TaxDataTaxRateSearchResultsInterface');
    }
}
