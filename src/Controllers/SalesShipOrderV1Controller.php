 ...
 */
class SalesShipOrderV1Controller extends BaseController
{
    /**
     * @var SalesShipOrderV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SalesShipOrderV1Controller The *Singleton* instance.
     */
     ...
     * @param Models\SalesShipOrderV1ExecutePostBody $salesShipOrderV1ExecutePostBody (optional) TODO: type description
     *                                                                                here
     * @return integer response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createSalesShipOrderV1ExecutePost(
        $orderId,
        ...
        $_queryBuilder = $_queryBuilder.'/V1/order/{orderId}/ship';
        ...
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($salesShipOrderV1ExecutePostBody));
