 ...
 */
class TaxTaxRuleRepositoryV1Controller extends BaseController
{
    /**
     * @var TaxTaxRuleRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return TaxTaxRuleRepositoryV1Controller The *Singleton* instance.
     */
     ...
     * Save TaxRule
     *
     * @param Models\TaxTaxRuleRepositoryV1SavePutBody $taxTaxRuleRepositoryV1SavePutBody (optional) TODO: type
     *                                                                                    description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateTaxTaxRuleRepositoryV1SavePut(
        $taxTaxRuleRepositoryV1SavePutBody = null
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/taxRules';
        ...
        $response = Request::put($_queryUrl, $_headers, Request\Body::Json($taxTaxRuleRepositoryV1SavePutBody));
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\TaxDataTaxRuleInterface');
    }

    /**
     * Save TaxRule
     *
     * @param Models\TaxTaxRuleRepositoryV1SavePutBody $taxTaxRuleRepositoryV1SavePostBody (optional) TODO: type
     *                                                                                     description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createTaxTaxRuleRepositoryV1SavePost(
        $taxTaxRuleRepositoryV1SavePostBody = null
    ) {
        ...
        //and invoke the API call request to fetch the response
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($taxTaxRuleRepositoryV1SavePostBody));
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getTaxTaxRuleRepositoryV1GetGet(
        $ruleId
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/taxRules/{ruleId}';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteTaxTaxRuleRepositoryV1DeleteByIdDelete(
        $ruleId
    ) {
    ...
    /**
     * Search TaxRules This call returns an array of objects, but detailed information about each object’s
     * attributes might not be included. See http://devdocs.magento.com/codelinks/attributes.
     * html#TaxRuleRepositoryInterface to determine which call to use to get detailed information about all
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getTaxTaxRuleRepositoryV1GetListGet(
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/taxRules/search';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\TaxDataTaxRuleSearchResultsInterface');
    }
}
