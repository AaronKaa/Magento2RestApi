 ...
 */
class SalesRuleRuleRepositoryV1Controller extends BaseController
{
    /**
     * @var SalesRuleRuleRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SalesRuleRuleRepositoryV1Controller The *Singleton* instance.
     */
     ...
     * Get rule by ID.
     *
     * @param integer $ruleId TODO: type description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function getSalesRuleRuleRepositoryV1GetByIdGet(
        $ruleId
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/salesRules/{ruleId}';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\SalesRuleDataRuleInterface');
    }

    /**
     * Save sales rule.
     *
     * @param string                                      $ruleId                               TODO: type description
     *                                                                                          here
     * @param Models\SalesRuleRuleRepositoryV1SavePutBody $salesRuleRuleRepositoryV1SavePutBody (optional) TODO: type
     *                                                                                          description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateSalesRuleRuleRepositoryV1SavePut(
        $ruleId,
        ...
        //and invoke the API call request to fetch the response
        $response = Request::put($_queryUrl, $_headers, Request\Body::Json($salesRuleRuleRepositoryV1SavePutBody));
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteSalesRuleRuleRepositoryV1DeleteByIdDelete(
        $ruleId
    ) {
    ...
    /**
     * Retrieve sales rules that match te specified criteria. This call returns an array of objects, but
     * detailed information about each object’s attributes might not be included. See http://devdocs.
     * magento.com/codelinks/attributes.html#RuleRepositoryInterface to determine which call to use to get
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getSalesRuleRuleRepositoryV1GetListGet(
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/salesRules/search';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\SalesRuleDataRuleSearchResultInterface');
    }

    /**
     * Save sales rule.
     *
     * @param Models\SalesRuleRuleRepositoryV1SavePutBody $salesRuleRuleRepositoryV1SavePostBody (optional) TODO: type
     *                                                                                           description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createSalesRuleRuleRepositoryV1SavePost(
        $salesRuleRuleRepositoryV1SavePostBody = null
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/salesRules';
        ...
        //and invoke the API call request to fetch the response
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($salesRuleRuleRepositoryV1SavePostBody));
