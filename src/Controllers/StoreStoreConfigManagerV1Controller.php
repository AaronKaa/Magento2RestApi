 ...
 */
class StoreStoreConfigManagerV1Controller extends BaseController
{
    /**
     * @var StoreStoreConfigManagerV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return StoreStoreConfigManagerV1Controller The *Singleton* instance.
     */
     ...
     *
     * @param array $storeCodes (optional) TODO: type description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function getStoreStoreConfigManagerV1GetStoreConfigsGet(
        $storeCodes = null
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/store/storeConfigs';
        ...
        return $mapper->mapClassArray($response->body, 'MagentoCommunityLib\\Models\\StoreDataStoreConfigInterface');
    }
}
