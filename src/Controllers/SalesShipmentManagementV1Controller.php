 ...
 */
class SalesShipmentManagementV1Controller extends BaseController
{
    /**
     * @var SalesShipmentManagementV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SalesShipmentManagementV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getSalesShipmentManagementV1GetCommentsListGet(
        $id
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/shipment/{id}/comments';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\SalesDataShipmentCommentSearchResultInterface');
    }
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createSalesShipmentManagementV1NotifyPost(
        $id
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/shipment/{id}/emails';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getSalesShipmentManagementV1GetLabelGet(
        $id
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/shipment/{id}/label';
