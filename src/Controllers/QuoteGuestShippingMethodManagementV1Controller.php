 ...
 */
class QuoteGuestShippingMethodManagementV1Controller extends BaseController
{
    /**
     * @var QuoteGuestShippingMethodManagementV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return QuoteGuestShippingMethodManagementV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getQuoteGuestShippingMethodManagementV1GetListGet(
        $cartId
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/guest-carts/{cartId}/shipping-methods';
