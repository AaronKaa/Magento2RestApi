 ...
 */
class CatalogProductRenderListV1Controller extends BaseController
{
    /**
     * @var CatalogProductRenderListV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return CatalogProductRenderListV1Controller The *Singleton* instance.
     */
    ...
    /**
     * Collect and retrieve the list of product render info This info contains raw prices and formated
     * prices, product name, stock status, store_id, etc
     *
     * @param integer $storeId                                                  TODO: type description here
     * @param string  $currencyCode                                             TODO: type description here
     ...
     */
    public function getCatalogProductRenderListV1GetListGet(
        $storeId,
        $currencyCode,
        ...
        $_queryBuilder = $_queryBuilder.'/V1/products-render-info';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\CatalogDataProductRenderSearchResultsInterface');
    }
}
