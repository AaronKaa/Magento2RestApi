 ...
 */
class AmazonPaymentOrderInformationManagementV1Controller extends BaseController
{
    /**
     * @var AmazonPaymentOrderInformationManagementV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return AmazonPaymentOrderInformationManagementV1Controller The *Singleton* instance.
     */
     ...
     */
    public function deleteAmazonPaymentOrderInformationManagementV1RemoveOrderReferenceDelete()
    {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/amazon/order-ref';
