 ...
 */
class TemandoShippingRmaRmaShipmentManagementV1Controller extends BaseController
{
    /**
     * @var TemandoShippingRmaRmaShipmentManagementV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return TemandoShippingRmaRmaShipmentManagementV1Controller The *Singleton* instance.
     */
     ...
     *
     * @param integer                                                                  $rmaId                                                             TODO: type
     *                                                                                                                                                    description here
     * @param Models\TemandoShippingRmaRmaShipmentManagementV1AssignShipmentIdsPutBody $temandoShippingRmaRmaShipmentManagementV1AssignShipmentIdsPutBody (optional) TODO:
     *                                                                                                                                                    type description
     *                                                                                                                                                    here
     * @return integer response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateTemandoShippingRmaRmaShipmentManagementV1AssignShipmentIdsPut(
        $rmaId,
        ...
        $_queryBuilder = $_queryBuilder.'/V1/temando/rma/{rmaId}/shipments';
        ...
        $response = Request::put(
            $_queryUrl,
            $_headers,
            Request\Body::Json($temandoShippingRmaRmaShipmentManagementV1AssignShipmentIdsPutBody)
        );
