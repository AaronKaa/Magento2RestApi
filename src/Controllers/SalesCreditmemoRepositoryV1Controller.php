 ...
 */
class SalesCreditmemoRepositoryV1Controller extends BaseController
{
    /**
     * @var SalesCreditmemoRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SalesCreditmemoRepositoryV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getSalesCreditmemoRepositoryV1GetGet(
        $id
    ) {
    ...
    /**
     * Lists credit memos that match specified search criteria. This call returns an array of objects, but
     * detailed information about each object’s attributes might not be included. See http://devdocs.
     * magento.com/codelinks/attributes.html#CreditmemoRepositoryInterface to determine which call to use
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getSalesCreditmemoRepositoryV1GetListGet(
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/creditmemos';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\SalesDataCreditmemoSearchResultInterface');
    }

    /**
     * Performs persist operations for a specified credit memo.
     *
     * @param Models\SalesCreditmemoRepositoryV1SavePostBody $salesCreditmemoRepositoryV1SavePostBody (optional) TODO:
     *                                                                                                type description
     *                                                                                                here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createSalesCreditmemoRepositoryV1SavePost(
        $salesCreditmemoRepositoryV1SavePostBody = null
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/creditmemo';
        ...
        $response = Request::post(
            $_queryUrl,
            $_headers,
            Request\Body::Json($salesCreditmemoRepositoryV1SavePostBody)
        );
