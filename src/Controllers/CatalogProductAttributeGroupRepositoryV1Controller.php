 ...
 */
class CatalogProductAttributeGroupRepositoryV1Controller extends BaseController
{
    /**
     * @var CatalogProductAttributeGroupRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return CatalogProductAttributeGroupRepositoryV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getCatalogProductAttributeGroupRepositoryV1GetListGet(
        ...
        $_queryBuilder = $_queryBuilder.'/V1/products/attribute-sets/groups/list';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\EavDataAttributeGroupSearchResultsInterface');
    }

    /**
     * Save attribute group
     *
     * @param Models\CatalogProductAttributeGroupRepositoryV1SavePostBody $catalogProductAttributeGroupRepositoryV1SavePostBody (optional) TODO:
     *                                                                                                                          type description
     *                                                                                                                          here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createCatalogProductAttributeGroupRepositoryV1SavePost(
        $catalogProductAttributeGroupRepositoryV1SavePostBody = null
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/products/attribute-sets/groups';
        ...
        $response = Request::post(
            $_queryUrl,
            $_headers,
            Request\Body::Json($catalogProductAttributeGroupRepositoryV1SavePostBody)
        );
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\EavDataAttributeGroupInterface');
    }

    /**
     * Save attribute group
     *
     * @param string                                                      $attributeSetId                                      TODO: type
     *                                                                                                                         description here
     * @param Models\CatalogProductAttributeGroupRepositoryV1SavePostBody $catalogProductAttributeGroupRepositoryV1SavePutBody (optional) TODO:
     *                                                                                                                         type description
     *                                                                                                                         here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateCatalogProductAttributeGroupRepositoryV1SavePut(
        $attributeSetId,
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/products/attribute-sets/{attributeSetId}/groups';
        ...
        $response = Request::put(
            $_queryUrl,
            $_headers,
            Request\Body::Json($catalogProductAttributeGroupRepositoryV1SavePutBody)
        );
     ...
     *
     * @param integer $groupId TODO: type description here
     * @return bool response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function deleteCatalogProductAttributeGroupRepositoryV1DeleteByIdDelete(
        $groupId
    ) {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/products/attribute-sets/groups/{groupId}';
