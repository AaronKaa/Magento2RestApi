 ...
 */
class CustomerCustomerRepositoryV1Controller extends BaseController
{
    /**
     * @var CustomerCustomerRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return CustomerCustomerRepositoryV1Controller The *Singleton* instance.
     */
     ...
     */
    public function getCustomerCustomerRepositoryV1GetByIdGet(
        $customerId
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/V1/customers/{customerId}';
     ...
     *
     * @param string                                         $customerId                              TODO: type
     *                                                                                                description here
     * @param Models\CustomerCustomerRepositoryV1SavePutBody $customerCustomerRepositoryV1SavePutBody (optional) TODO:
     *                                                                                                type description
     *                                                                                                here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateCustomerCustomerRepositoryV1SavePut(
        $customerId,
        ...
        //and invoke the API call request to fetch the response
        $response = Request::put($_queryUrl, $_headers, Request\Body::Json($customerCustomerRepositoryV1SavePutBody));
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteCustomerCustomerRepositoryV1DeleteByIdDelete(
        $customerId
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getCustomerCustomerRepositoryV1GetByIdGet1()
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/customers/me';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateCustomerCustomerRepositoryV1SavePut1(
        $customerCustomerRepositoryV1SavePutBody = null
    ) {
    ...
    /**
     * Retrieve customers which match a specified criteria. This call returns an array of objects, but
     * detailed information about each object’s attributes might not be included. See http://devdocs.
     * magento.com/codelinks/attributes.html#CustomerRepositoryInterface to determine which call to use to
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getCustomerCustomerRepositoryV1GetListGet(
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/customers/search';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\CustomerDataCustomerSearchResultsInterface');
    }
}
