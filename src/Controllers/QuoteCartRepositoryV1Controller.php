 ...
 */
class QuoteCartRepositoryV1Controller extends BaseController
{
    /**
     * @var QuoteCartRepositoryV1Controller The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return QuoteCartRepositoryV1Controller The *Singleton* instance.
     */
     ...
     *
     * @param integer $cartId TODO: type description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function getQuoteCartRepositoryV1GetGet(
        $cartId
    ) {
    ...
    /**
     * Enables administrative users to list carts that match specified search criteria. This call returns
     * an array of objects, but detailed information about each object’s attributes might not be included.
     * See http://devdocs.magento.com/codelinks/attributes.html#CartRepositoryInterface to determine which
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getQuoteCartRepositoryV1GetListGet(
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/V1/carts/search';
        ...
        return $mapper->mapClass($response->body, 'MagentoCommunityLib\\Models\\QuoteDataCartSearchResultsInterface');
    }

    /**
     * Save quote
     *
     * @param Models\QuoteCartRepositoryV1SavePutBody $quoteCartRepositoryV1SavePutBody (optional) TODO: type
     *                                                                                  description here
     * @return void response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateQuoteCartRepositoryV1SavePut(
        $quoteCartRepositoryV1SavePutBody = null
    ) {
        ...
        //and invoke the API call request to fetch the response
        $response = Request::put($_queryUrl, $_headers, Request\Body::Json($quoteCartRepositoryV1SavePutBody));
