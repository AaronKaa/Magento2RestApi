...
/**
 *Invoice comment interface. An invoice is a record of the receipt of payment for an order. An
 * invoice can include comments that detail the invoice history.
 */
class SalesDataInvoiceCommentInterface implements JsonSerializable
{
    /**
