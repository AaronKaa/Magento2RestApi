 ...
 */
class SalesRuleDataCouponSearchResultInterface implements JsonSerializable
{
    /**
     * Rules.
     * @required
     * @var \MagentoCommunityLib\Models\SalesRuleDataCouponInterface[] $items public property
     */
    public $items;
