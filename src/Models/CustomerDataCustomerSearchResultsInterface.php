 ...
 */
class CustomerDataCustomerSearchResultsInterface implements JsonSerializable
{
    /**
     * Customers list.
     * @required
     * @var \MagentoCommunityLib\Models\CustomerDataCustomerInterface[] $items public property
     */
    public $items;
