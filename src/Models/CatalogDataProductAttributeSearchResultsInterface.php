 ...
 */
class CatalogDataProductAttributeSearchResultsInterface implements JsonSerializable
{
    /**
     * Attributes list.
     * @required
     * @var \MagentoCommunityLib\Models\CatalogDataProductAttributeInterface[] $items public property
     */
    public $items;
