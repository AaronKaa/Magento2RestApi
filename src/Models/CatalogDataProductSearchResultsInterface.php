 ...
 */
class CatalogDataProductSearchResultsInterface implements JsonSerializable
{
    /**
     * Attributes list.
     * @required
     * @var \MagentoCommunityLib\Models\CatalogDataProductInterface[] $items public property
     */
    public $items;
