 ...
 */
class EavDataAttributeSetSearchResultsInterface implements JsonSerializable
{
    /**
     * Attribute sets list.
     * @required
     * @var \MagentoCommunityLib\Models\EavDataAttributeSetInterface[] $items public property
     */
    public $items;
