...
/**
 *Invoice comment search result interface. An invoice is a record of the receipt of payment for an
 * order. An invoice can include comments that detail the invoice history.
 */
class SalesDataInvoiceCommentSearchResultInterface implements JsonSerializable
{
    /**
     * Array of collection items.
     * @required
     * @var \MagentoCommunityLib\Models\SalesDataInvoiceCommentInterface[] $items public property
     */
    public $items;
