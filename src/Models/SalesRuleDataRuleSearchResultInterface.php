 ...
 */
class SalesRuleDataRuleSearchResultInterface implements JsonSerializable
{
    /**
     * Rules.
     * @required
     * @var \MagentoCommunityLib\Models\SalesRuleDataRuleInterface[] $items public property
     */
    public $items;
