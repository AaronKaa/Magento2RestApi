 ...
 */
class CatalogDataCategorySearchResultsInterface implements JsonSerializable
{
    /**
     * Categories
     * @required
     * @var \MagentoCommunityLib\Models\CatalogDataCategoryInterface[] $items public property
     */
    public $items;
