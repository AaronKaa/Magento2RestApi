 ...
 */
class CatalogDataCategoryAttributeSearchResultsInterface implements JsonSerializable
{
    /**
     * Attributes list.
     * @required
     * @var \MagentoCommunityLib\Models\CatalogDataCategoryAttributeInterface[] $items public property
     */
    public $items;
