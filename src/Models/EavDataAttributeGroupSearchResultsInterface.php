 ...
 */
class EavDataAttributeGroupSearchResultsInterface implements JsonSerializable
{
    /**
     * Attribute sets list.
     * @required
     * @var \MagentoCommunityLib\Models\EavDataAttributeGroupInterface[] $items public property
     */
    public $items;
