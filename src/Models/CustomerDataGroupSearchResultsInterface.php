 ...
 */
class CustomerDataGroupSearchResultsInterface implements JsonSerializable
{
    /**
     * Customer groups list.
     * @required
     * @var \MagentoCommunityLib\Models\CustomerDataGroupInterface[] $items public property
     */
    public $items;
