...
/**
 *Credit memo search result interface. After a customer places and pays for an order and an invoice
 * has been issued, the merchant can create a credit memo to refund all or part of the amount paid for
 * any returned or undelivered items. The memo restores funds to the customer account so that the
 * customer can make future purchases.
 */
class SalesDataCreditmemoSearchResultInterface implements JsonSerializable
{
    /**
     * Array of collection items.
     * @required
     * @var \MagentoCommunityLib\Models\SalesDataCreditmemoInterface[] $items public property
     */
    public $items;
