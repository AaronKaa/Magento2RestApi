...
/**
 *Shipment package interface. A shipment is a delivery package that contains products. A shipment
 * document accompanies the shipment. This document lists the products and their quantities in the
 * delivery package.
 */
class SalesDataShipmentPackageCreationInterface implements JsonSerializable
{
    /**
