...
/**
 *Shipment comment search result interface. A shipment is a delivery package that contains products.
 * A shipment document accompanies the shipment. This document lists the products and their quantities
 * in the delivery package. A shipment document can contain comments.
 */
class SalesDataShipmentCommentSearchResultInterface implements JsonSerializable
{
    /**
     * Array of collection items.
     * @required
     * @var \MagentoCommunityLib\Models\SalesDataShipmentCommentInterface[] $items public property
     */
    public $items;
